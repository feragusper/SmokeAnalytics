...
fun AboutSection() {
    ...
    AboutCard(
        ...
        body = "Smoke Analytics is a personal smoking journal focused on visibility over guilt. It helps you review the day, compare longer trends, estimate cost, and understand where or when smoking clusters show up across the app."
    )
