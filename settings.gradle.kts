...
include(":features:goals:presentation:mobile")
include(":features:goals:presentation:web")
...
include(":libraries:cravings:data:mobile")
include(":libraries:cravings:data:web")
include(":libraries:cravings:domain")
