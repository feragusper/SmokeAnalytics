...
object SmokeWebStyles : StyleSheet() {
    ...
    val appRoot by style {
        ...
        property("--sa-color-primary", "#2E7A84")
        property("--sa-color-onPrimary", "#FFFFFF")
        property("--sa-color-primary-soft", "rgba(46,122,132,0.10)")
        property("--sa-color-secondary", "#5B6F73")
        property("--sa-color-bg", "#F6F8F8")
        property("--sa-color-bg-accent", "#EBF1F2")
        property("--sa-color-onBg", "#142022")
        property("--sa-color-surface", "#FFFFFF")
        property("--sa-color-surface-strong", "#F9FBFB")
        property("--sa-color-onSurface", "#142022")
        property("--sa-color-outline", "rgba(20,32,34,0.10)")
        property("--sa-color-outline-strong", "rgba(20,32,34,0.18)")
        property("--sa-color-danger", "#BA1A1A")
        property("--sa-color-danger-soft", "rgba(186,26,26,0.10)")
        property("--sa-color-success-soft", "rgba(46,122,132,0.10)")
        property("--sa-color-success", "#2E7A84")
    ...
    val appRootDarkTokens by style {
        property("--sa-color-primary", "#97D7DE")
        property("--sa-color-onPrimary", "#10343A")
        property("--sa-color-primary-soft", "rgba(151,215,222,0.14)")
        property("--sa-color-secondary", "#C1D1D4")
        property("--sa-color-bg", "#071112")
        property("--sa-color-bg-accent", "#0D1416")
        property("--sa-color-onBg", "#E6EFEF")
        property("--sa-color-surface", "#0D1416")
        property("--sa-color-surface-strong", "#152124")
        property("--sa-color-onSurface", "#C1D1D4")
        ...
        property("--sa-color-success-soft", "rgba(151,215,222,0.12)")
        property("--sa-color-success", "#97D7DE")
    }
    ...
    val sidebar by style {
        property("width", "296px")
        property("flex", "0 0 296px")
        property("box-sizing", "border-box")
        padding(24.px)
